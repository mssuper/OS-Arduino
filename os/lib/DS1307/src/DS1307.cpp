...
char *DS1307::getDOWStr(uint8_t format)
{
	...
	{
		case SEGUNDA:
			strcpy(output,"Segunda");
			break;
		case TERCA:
			strcpy(output,"Terça");
			break;
		case QUARTA:
			strcpy(output,"Quarta");
			break;
		case QUINTA:
			strcpy(output,"Quinta");
			break;
		case SEXTA:
			strcpy(output,"Sexta");
			break;
		case SABADO:
			strcpy(output,"Sábado");
			break;
		case DOMINGO:
			strcpy(output,"Domingo");
			break;
	}     
	if (format==FORMAT_SHORT)
		output[3]=0;
...
char *DS1307::getMonthStr(uint8_t format)
{
	...
	{
		case 1:
			strcpy(output,"Janeiro");
			break;
		case 2:
			strcpy(output,"Fevereiro");
			break;
		case 3:
			strcpy(output,"Março");
			break;
		...
		case 7:
			...
			break;
		case 8:
			strcpy(output,"Augosto");
			break;
		case 9:
			strcpy(output,"Setembro");
			break;
		case 10:
			strcpy(output,"Outubro");
			break;
		case 11:
			strcpy(output,"Novembro");
			break;
		case 12:
			strcpy(output,"Dezembro");
			break;
	}     
	if (format==FORMAT_SHORT)
		output[3]=0;
